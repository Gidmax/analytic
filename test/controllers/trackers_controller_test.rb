...
class TrackersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tracker" do
    assert_difference('Tracker.count') do
      post trackers_url, params: { tracker: { code: @tracker.code, count_of_access: @tracker.count_of_access, desc: @tracker.desc, user_id: @tracker.user_id } }
    end
  ...
  test "should update tracker" do
    patch tracker_url(@tracker), params: { tracker: { code: @tracker.code, count_of_access: @tracker.count_of_access, desc: @tracker.desc, user_id: @tracker.user_id } }
